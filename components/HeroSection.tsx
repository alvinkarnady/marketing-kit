  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p
          className="text-white/80 text-lg md:text-xl mb-10 leading-relaxed max-w-2xl mx-auto"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="flex items-center gap-2 text-white/90">
            ...
            <span className="text-sm">Pasangan Bahagia</span>
          </div>
      ...
      >
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="group relative inline-flex items-center gap-2 px-8 py-4 rounded-full font-semibold text-lg overflow-hidden"
        >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="group inline-flex items-center gap-2 px-8 py-4 rounded-full font-semibold text-lg border-2 border-white/30 bg-white/5 backdrop-blur-sm hover:bg-white/10 hover:border-white/50 transition-all"
        >
